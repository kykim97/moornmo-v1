<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <Date label="AccountDate" v-model="item.accountDate" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Type" v-model="item.type" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="Number" v-model="item.number" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Client" v-model="item.client" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <String label="Manager" v-model="item.manager" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="RegisterName" v-model="item.registerName" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="OrderItem" v-model="item.orderItem" :editMode="editMode" @change="change" />
            </div>
            <div>
