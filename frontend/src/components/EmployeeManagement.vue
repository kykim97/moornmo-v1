<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            EmployeeManagement # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            EmployeeManagement
        </v-card-title >
        ...
        <v-card-text>
            ...
            <String label="Position" v-model="value.position" :editMode="editMode"/>
            <String label="PhoneNo" v-model="value.phoneNo" :editMode="editMode"/>
            <Date label="EnteringDate" v-model="value.enteringDate" :editMode="editMode"/>
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            websocketUrl.pathname = "/rsocket/employeeManagements";
            websocketUrl.hash = "";
            ...
            client.connect().subscribe({
                ...
                const endpoint = "employeeManagements."+ me.value.id +".get"
