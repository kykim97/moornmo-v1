<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            <Date label="AccountDate" v-model="value.accountDate" :editMode="editMode"/>
            <String label="Type" v-model="value.type" :editMode="editMode"/>
            <Number label="Number" v-model="value.number" :editMode="editMode"/>
            <String label="Client" v-model="value.client" :editMode="editMode"/>
            ...
            <String label="Manager" v-model="value.manager" :editMode="editMode"/>
            <String label="RegisterName" v-model="value.registerName" :editMode="editMode"/>
            <Number label="OrderItem" v-model="value.orderItem" :editMode="editMode"/>
